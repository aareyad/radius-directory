...
class General {
	...
	public function __construct() {
		...
		add_action( 'radius_directory_breadcrumb', [ $this, 'breadcrumb' ] );
	...
	public function theme_setup() {
		...
		$sizes = apply_filters( 'radius_directory_image_size', $sizes );
		...
		register_nav_menus(
			[
				'primary' => esc_html__( 'Primary', 'radius-directory' ),
			]
		);
	}
	...
	public function register_sidebars() {
		...
		register_sidebar(
			[
				'name'          => esc_html__( 'Sidebar', 'radius-directory' ),
				'id'            => 'sidebar',
		...
		$footer_widget_titles = [
			'1' => esc_html__( 'Footer 1', 'radius-directory' ),
			'2' => esc_html__( 'Footer 2', 'radius-directory' ),
			'3' => esc_html__( 'Footer 3', 'radius-directory' ),
			'4' => esc_html__( 'Footer 4', 'radius-directory' ),
		];
	...
	public function body_classes( $classes ) {
		...
		$classes[] = 'theme-radius-directory';
            ...
            <div class="search-box">
                    <div class="form-group mb-0">
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="' . esc_attr__( 'Search here...', 'radius-directory' ) . '" value="' . get_search_query() . '" name="s" />
                            <button>
	...
	public function breadcrumb() {
		$args = [
			...
			'before'      => '',
			'after'       => '',
			'home'        => _x( 'Home', 'breadcrumb', 'radius-directory' ),
		];
