...
class Contact_Info extends Customizer {
	...
	public function register_contact_controls( $wp_customize ) {
		...
		$wp_customize->add_control( 'contact_address',
			[
				'label'   => __( 'Address', 'radius-directory' ),
		...
		$wp_customize->add_control( 'contact_phone',
			[
				'label'   => __( 'Phone', 'radius-directory' ),
				'section' => 'contact_info_section',
				'type'    => 'text',
			]
		);
		...
		$wp_customize->add_control( 'contact_email',
			[
				'label'   => __( 'Email', 'radius-directory' ),
				'section' => 'contact_info_section',
				'type'    => 'email',
			]
		);
		...
		$wp_customize->add_control( 'facebook',
			[
				'label'   => __( 'Facebook', 'radius-directory' ),
				'section' => 'contact_info_section',
				'type'    => 'url',
			]
		);
		...
		$wp_customize->add_control( 'twitter',
			[
				'label'   => __( 'Twitter', 'radius-directory' ),
				'section' => 'contact_info_section',
				'type'    => 'url',
			]
		);
		...
		$wp_customize->add_control( 'instagram',
			[
				'label'   => __( 'Instagram', 'radius-directory' ),
				'section' => 'contact_info_section',
				'type'    => 'url',
			]
		);
		...
		$wp_customize->add_control( 'linkedin',
			[
				'label'   => __( 'Linkedin', 'radius-directory' ),
				'section' => 'contact_info_section',
				'type'    => 'url',
			]
		);
		...
		$wp_customize->add_control( 'youtube',
			[
				'label'   => __( 'Youtube', 'radius-directory' ),
				'section' => 'contact_info_section',
				'type'    => 'url',
			]
		);
		...
		$wp_customize->add_control( 'pinterest',
			[
				'label'   => __( 'Pinterest', 'radius-directory' ),
				'section' => 'contact_info_section',
				'type'    => 'url',
			]
		);
		...
		$wp_customize->add_control( 'skype',
			[
				'label'   => __( 'Skype', 'radius-directory' ),
				'section' => 'contact_info_section',
				'type'    => 'url',
			]
		);
