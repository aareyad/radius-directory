	...
	public function register_blog_layout_controls( $wp_customize ) {
		...
		$wp_customize->add_control( new Image_Radio( $wp_customize, 'blog_layout',
			[
				...
				'description' => esc_html__( 'Select the default template layout for blog archive', 'radius-directory' ),
		...
		$wp_customize->add_control( 'blog_padding_top',
			[
				...
				'description' => esc_html__( 'Blog Archive Content Padding Top ', 'radius-directory' ),
				'section'     => 'blog_layout_section',
				'type'        => 'text',
			]
		);
		...
		$wp_customize->add_control( 'blog_padding_bottom',
			[
				...
				'description' => esc_html__( 'Blog Archive Content Padding Bottom', 'radius-directory' ),
				'section'     => 'blog_layout_section',
				'type'        => 'text',
			]
		);
