...
class General extends Customizer {
	...
	public function register_general_controls( $wp_customize ) {
		...
		$wp_customize->add_control( new WP_Customize_Media_Control( $wp_customize, 'logo',
			[
				'label'         => esc_html__( 'Main Logo', 'radius-directory' ),
				'description'   => esc_html__( 'Add site main logo', 'radius-directory' ),
				'section'       => 'general_section',
				'mime_type'     => 'image',
				'button_labels' => [
					'select'       => esc_html__( 'Select Logo', 'radius-directory' ),
					'change'       => esc_html__( 'Change Logo', 'radius-directory' ),
		...
		$wp_customize->add_control( new WP_Customize_Media_Control( $wp_customize, 'logo_light',
			[
				'label'         => esc_html__( 'Light Logo', 'radius-directory' ),
				'description'   => esc_html__( 'Add logo for transparent header', 'radius-directory' ),
				'section'       => 'general_section',
				'mime_type'     => 'image',
				'button_labels' => [
					'select'       => esc_html__( 'Select Logo', 'radius-directory' ),
		...
		$wp_customize->add_control( new WP_Customize_Media_Control( $wp_customize, 'mobile_logo',
			[
				'label'         => esc_html__( 'Mobile Logo', 'radius-directory' ),
				'description'   => esc_html__( 'Add logo for mobile header', 'radius-directory' ),
				'section'       => 'general_section',
				'mime_type'     => 'image',
				'button_labels' => [
					'select'       => esc_html__( 'Select Logo', 'radius-directory' ),
		...
		$wp_customize->add_control( 'logo_width',
			[
				'label'           => esc_html__( 'Logo max width', 'radius-directory' ),
				'section'         => 'general_section',
				'type'            => 'text',
				'description'     => esc_html__( 'Enter logo width. Eg: 200px', 'radius-directory' ),
				'input_attrs'     => [
					'placeholder' => esc_html__( '200px', 'radius-directory' ),
				],
			]
		);
		...
		$wp_customize->add_control( new WP_Customize_Media_Control( $wp_customize, 'banner_image',
			[
				'label'         => esc_html__( 'Banner Image', 'radius-directory' ),
				'description'   => esc_html__( 'Add banner image to change default image', 'radius-directory' ),
				'section'       => 'general_section',
				'mime_type'     => 'image',
				'button_labels' => [
		...
		$wp_customize->add_control( new Switcher( $wp_customize, 'back_to_top',
			[
				'label'   => esc_html__( 'Back to Top', 'radius-directory' ),
				'section' => 'general_section',
			]
		) );
		...
		$wp_customize->add_control( new Switcher( $wp_customize, 'remove_admin_bar',
			[
				'label'       => esc_html__( 'Remove Admin Bar', 'radius-directory' ),
				'section'     => 'general_section',
				'description' => esc_html__( 'This option not work for administrator users.', 'radius-directory' ),
			]
		) );
