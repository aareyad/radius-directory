	...
	public function register_page_layout_controls( $wp_customize ) {
		...
		$wp_customize->add_control( new Image_Radio( $wp_customize, 'page_layout',
			[
				...
				'description' => esc_html__( 'Select the default template layout for Pages', 'radius-directory' ),
		...
		$wp_customize->add_control( 'page_menu_alignment', [
			...
			'label'   => __( 'Menu Alignment', 'radius-directory' ),
			'choices' => [
				'default'     => esc_html__( 'Default', 'radius-directory' ),
		...
		$wp_customize->add_control( 'page_padding_top',
			[
				...
				'description' => esc_html__( 'Page Content Padding Top ', 'radius-directory' ),
				'section'     => 'page_layout_section',
				'type'        => 'text',
			]
		);
		...
		$wp_customize->add_control( 'page_padding_bottom',
			[
				...
				'description' => esc_html__( 'Page Content Padding Bottom', 'radius-directory' ),
				'section'     => 'page_layout_section',
				'type'        => 'text',
			]
		);
