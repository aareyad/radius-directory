...
class Customizer {
	...
	public function add_customizer_panels( $wp_customize ) {
		...
		$wp_customize->add_panel( 'rttheme_layouts_defaults',
			[
				'title'       => esc_html__( 'Layout Settings', 'radius-directory' ),
				'description' => esc_html__( 'Adjust the overall layout for your site.', 'radius-directory' ),
				'priority'    => 17,
			]
		);
		// Color Panel
		$wp_customize->add_panel( 'rttheme_color_panel',
			[
				'title'       => esc_html__( 'Color', 'radius-directory' ),
				'description' => esc_html__( 'Change site color', 'radius-directory' ),
				'priority'    => 17,
			]
		);
	}
	...
	public function add_customizer_sections( $wp_customize ) {
		...
		$wp_customize->add_section( 'general_section',
			[
				'title'    => esc_html__( 'General', 'radius-directory' ),
				'priority' => 10,
			]
		);
		...
		$wp_customize->add_section( 'header_main_section',
			[
				'title'    => esc_html__( 'Header', 'radius-directory' ),
				'priority' => 11,
			]
		);
		// Add Footer Section
		$wp_customize->add_section( 'footer_section',
			[
				'title'    => esc_html__( 'Footer', 'radius-directory' ),
				'priority' => 12,
			]
		);
		// Add Color Section
		$wp_customize->add_section( 'site_color_section',
			[
				'title'    => esc_html__( 'Site Color', 'radius-directory' ),
		...
		$wp_customize->add_section( 'header_color_section',
			[
				'title'    => esc_html__( 'Header Color', 'radius-directory' ),
				'panel'    => 'rttheme_color_panel',
				'priority' => 12,
			]
		);
		$wp_customize->add_section( 'breadcrumb_color_section',
			[
				'title'    => esc_html__( 'Breadcrumb Color', 'radius-directory' ),
				'panel'    => 'rttheme_color_panel',
				'priority' => 13,
			]
		);
		$wp_customize->add_section( 'footer_color_section',
			[
				'title'    => esc_html__( 'Footer Color', 'radius-directory' ),
				'panel'    => 'rttheme_color_panel',
				'priority' => 14,
			]
		);
		...
		$wp_customize->add_section( 'blog_layout_section',
			[
				'title'    => esc_html__( 'Blog Layout', 'radius-directory' ),
				'priority' => 10,
		...
		$wp_customize->add_section( 'single_post_layout_section',
			[
				'title'    => esc_html__( 'Single Post Layout', 'radius-directory' ),
				'priority' => 10,
				'panel'    => 'rttheme_layouts_defaults',
			]
		);
		...
		$wp_customize->add_section( 'page_layout_section',
			[
				'title'    => esc_html__( 'Pages Layout', 'radius-directory' ),
				'priority' => 15,
				'panel'    => 'rttheme_layouts_defaults',
			]
		);
		...
		$wp_customize->add_section( 'error_layout_section',
			[
				'title'    => esc_html__( 'Error Layout', 'radius-directory' ),
				'priority' => 15,
				'panel'    => 'rttheme_layouts_defaults',
			]
		);
		...
		$wp_customize->add_section( 'listing_archive_layout_section',
			[
				'title'    => esc_html__( 'Listing Archive Layout', 'radius-directory' ),
				'priority' => 20,
				'panel'    => 'rttheme_layouts_defaults',
			]
		);
		...
		$wp_customize->add_section( 'listing_single_layout_section',
			[
				'title'    => esc_html__( 'Listing Single Layout', 'radius-directory' ),
				'priority' => 21,
				'panel'    => 'rttheme_layouts_defaults',
			]
		);
		...
		$wp_customize->add_section( 'blog_archive_section',
			[
				'title'    => esc_html__( 'Blog', 'radius-directory' ),
				'priority' => 15,
			]
		);
		...
		$wp_customize->add_section( 'single_post_section',
			[
				'title'    => esc_html__( 'Post Details', 'radius-directory' ),
				'priority' => 16,
			]
		);
		...
		$wp_customize->add_section( 'listings_section',
			[
				'title'    => esc_html__( 'Listing Settings', 'radius-directory' ),
				'priority' => 17,
			]
		);
		// Contact Info
		$wp_customize->add_section( 'contact_info_section',
			[
				'title'    => esc_html__( 'Contact & Social', 'radius-directory' ),
				'priority' => 17,
			]
		);
		...
		$wp_customize->add_section( 'error_section',
			[
				'title'    => esc_html__( 'Error Page', 'radius-directory' ),
				'priority' => 19,
			]
		);
	}
