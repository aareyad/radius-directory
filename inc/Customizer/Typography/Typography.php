...
namespace RadiusTheme\RadiusDirectory\Customizer\Typography;

use RadiusTheme\RadiusDirectory\Customizer\Controls\Separator;
use RadiusTheme\RadiusDirectory\Customizer\Default_Data;
...
class Typography {
	...
	public function register_typography_sections( $wp_customize ) {
		...
		$wp_customize->add_panel( 'rt_typo_panel',
			[
				'title'       => esc_html__( 'Typography', 'radius-directory' ),
				'description' => esc_html__( 'Change site typography.', 'radius-directory' ),
				'priority'    => 15,
			]
		);
		// Body
		$wp_customize->add_section( 'typography_body_section',
			[
				'title'    => esc_html__( 'Body', 'radius-directory' ),
				'priority' => 10,
				'panel'    => 'rt_typo_panel',
			]
		);
		...
		$wp_customize->add_section( 'typography_heading_section',
			[
				'title'    => esc_html__( 'Heading', 'radius-directory' ),
				'priority' => 12,
				'panel'    => 'rt_typo_panel',
			]
		);
		...
		$wp_customize->add_section( 'typography_menu_section',
			[
				'title'    => esc_html__( 'Menu', 'radius-directory' ),
				'priority' => 14,
				'panel'    => 'rt_typo_panel',
			]
		);
	...
	public function register_typography_controls( $wp_customize ) {
		...
		$wp_customize->add_control( new Control( $wp_customize, 'typo_body',
			[
				'label'       => __( 'Body', 'radius-directory' ),
		...
		$wp_customize->add_control( 'typo_body_size',
			[
				'label'       => __( 'Font Size', 'radius-directory' ),
				'description' => esc_html__( 'Font Size (px)', 'radius-directory' ),
				'section'     => 'typography_body_section',
				'type'        => 'text',
				'input_attrs' => [
					'class' => 'rtt-txt-box',
		...
		$wp_customize->add_control( 'typo_body_height',
			[
				'label'       => __( 'Line Height', 'radius-directory' ),
				'description' => esc_html__( 'Line Height (px)', 'radius-directory' ),
				'section'     => 'typography_body_section',
				'type'        => 'text',
				'input_attrs' => [
					'class' => 'rtt-txt-box',
		...
		$wp_customize->add_control( new Control( $wp_customize, 'typo_heading',
			[
				'label'       => esc_html__( 'All Heading Typography (H1-H6)', 'radius-directory' ),
		...
		$wp_customize->add_control( new Control( $wp_customize, 'typo_h1',
			[
				'label'       => __( 'Header h1 ', 'radius-directory' ),
				'section'     => 'typography_heading_section',
				'input_attrs' => [
					'font_count' => 'all',
					'orderby'    => 'popular',
		...
		$wp_customize->add_control( new Control( $wp_customize, 'typo_h2',
			[
				'label'       => __( 'Header h2 ', 'radius-directory' ),
				'section'     => 'typography_heading_section',
				'input_attrs' => [
					'font_count' => 'all',
					'orderby'    => 'popular',
		...
		$wp_customize->add_control( new Control( $wp_customize, 'typo_h3',
			[
				'label'       => __( 'Header h3 ', 'radius-directory' ),
				'section'     => 'typography_heading_section',
				'input_attrs' => [
					'font_count' => 'all',
					'orderby'    => 'popular',
		...
		$wp_customize->add_control( 'typo_h3_size',
			[
				'label'       => esc_html__( 'Font Size', 'radius-directory' ),
				'description' => esc_html__( 'Font Size (px)', 'radius-directory' ),
				'section'     => 'typography_heading_section',
				'type'        => 'text',
				'input_attrs' => [
		...
		$wp_customize->add_control( 'typo_h3_height',
			[
				'label'       => esc_html__( 'Line Height', 'radius-directory' ),
				'description' => esc_html__( 'Line Height (px)', 'radius-directory' ),
				'section'     => 'typography_heading_section',
				'type'        => 'text',
				'input_attrs' => [
		...
		$wp_customize->add_control( new Control( $wp_customize, 'typo_h4',
			[
				'label'       => esc_html__( 'Header h4 ', 'radius-directory' ),
				'section'     => 'typography_heading_section',
				'input_attrs' => [
					'font_count' => 'all',
					'orderby'    => 'popular',
		...
		$wp_customize->add_control( new Control( $wp_customize, 'typo_h5',
			[
				'label'       => esc_html__( 'Header h5 ', 'radius-directory' ),
				'section'     => 'typography_heading_section',
				'input_attrs' => [
					'font_count' => 'all',
					'orderby'    => 'popular',
		...
		$wp_customize->add_control( new Control( $wp_customize, 'typo_h6',
			[
				'label'       => esc_html__( 'Header h6 ', 'radius-directory' ),
				'section'     => 'typography_heading_section',
				'input_attrs' => [
					'font_count' => 'all',
					'orderby'    => 'popular',
		...
		$wp_customize->add_control( new Control( $wp_customize, 'typo_menu',
			[
				'label'       => esc_html__( 'Menu', 'radius-directory' ),
		...
		$wp_customize->add_control( 'typo_submenu_size',
			[
				'label'       => __( 'Sub Menu Font Size', 'radius-directory' ),
				'description' => esc_html__( 'Font Size (px)', 'radius-directory' ),
				'section'     => 'typography_menu_section',
				'type'        => 'text',
				'input_attrs' => [
		...
		$wp_customize->add_control( 'typo_submenu_height',
			[
				'label'       => __( 'Sub Menu Line Height', 'radius-directory' ),
				'description' => esc_html__( 'Line Height (px)', 'radius-directory' ),
				'section'     => 'typography_menu_section',
				'type'        => 'text',
				'input_attrs' => [
