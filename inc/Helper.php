...
class Helper {
	...
	public static function the_layout_class() {
		...
		echo apply_filters( 'radius_directory_layout_class', $layout_class );
	}
	...
	public static function the_sidebar_class() {
		...
		echo apply_filters( 'radius_directory_sidebar_class', $sidebar_class );
	}
	...
	public static function custom_sidebar_fields() {
		$base                                   = 'radius_directory';
		$sidebar_fields                         = [];
		$sidebar_fields['sidebar']              = esc_html__( 'Sidebar', 'radius-directory' );
		$sidebar_fields['rtcl-archive-sidebar'] = esc_html__( 'Listing Archive Sidebar', 'radius-directory' );
		$sidebar_fields['rtcl-single-sidebar']  = esc_html__( 'Listing Single Sidebar', 'radius-directory' );
	...
	public static function get_footer_list( $return_type = '' ) {
		...
		return apply_filters( 'radius_directory_footer_layout', $layout );
	}
	...
	public static function get_search_form_style() {
		$style = [
			'standard' => esc_html__( 'Standard', 'radius-directory' ),
		];

		if ( class_exists( 'RtclPro' ) ) {
			$style = array_merge( $style, [
				'popup'      => esc_html__( 'Popup', 'radius-directory' ),
				'suggestion' => esc_html__( 'Auto Suggestion', 'radius-directory' ),
				'dependency' => esc_html__( 'Dependency Selection', 'radius-directory' ),
			] );
		}
