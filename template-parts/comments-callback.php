    ...
    <div class="flex-grow-1 comments-body">
        <div class="comment-meta clearfix">
            <div class="comment-meta-left">
                ...
                <div class="comment-time"><?php printf( esc_html__( ' %1$s ago / %2$s @ %3$s', 'radius-directory'), $human_time, $date, $time );?></div>
            </div>
			<?php
			comment_reply_link(
        ...
        <div class="comment-text">
			<?php if ( '0' == $comment->comment_approved ) : ?>
                <p class="comment-awaiting-moderation"><?php esc_html_e( 'Your comment is awaiting moderation.', 'radius-directory' ); ?></p>
			<?php endif; ?>
			<?php comment_text(); ?>
        </div>
    </div>
