...
$login_icon_title = is_user_logged_in() ? esc_html__( 'My Account', 'radius-directory' ) : esc_html__( 'Login/Register', 'radius-directory' );
?>
    ...
    <div class="header-icon-area">
		<?php if ( Helper::is_chat_enabled() ): ?>
            <a class="header-chat-icon rtcl-chat-unread-count"
               title="<?php esc_attr_e( 'Chat', 'radius-directory' ); ?>"
