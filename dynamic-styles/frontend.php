...
?>
:root {
--rtcl-primary-color: <?php echo esc_html( $primary_color ? $primary_color : '#00c194' ); ?>;
--rtcl-secondary-color: <?php echo esc_html( $secondary_color ? $secondary_color : '#07c196' ); ?>;
--rtcl-top-bg-color: <?php echo esc_html( $top_bg ? $top_bg : '#dff0f3' ); ?>;
--rtcl-link-hover-color: <?php echo esc_html( $secondary_color ? $secondary_color : '#07c196' ); ?>;
--rtcl-lite-primary-color: <?php echo esc_html( $lite_primary ? $lite_primary : '#eaf7f2' ); ?>;
}
<?php
/*-------------------------------------
#. Header
